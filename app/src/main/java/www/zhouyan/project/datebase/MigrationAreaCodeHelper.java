 ...
 */
public class MigrationAreaCodeHelper {
    private static final String CONVERSION_CLASS_NOT_FOUND_EXCEPTION = "MIGRATION HELPER - CLASS DOESN'T MATCH WITH THE CURRENT PARAMETERS";
    private static MigrationAreaCodeHelper instance;

    public static MigrationAreaCodeHelper getInstance() {
        if (instance == null) {
            instance = new MigrationAreaCodeHelper();
        }
        return instance;
    }
