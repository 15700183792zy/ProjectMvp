...
public class ToolAlert {
     ...
     */
    public static void loading(Context context, String message,
                               boolean cancelable, final ILoadingOnKeyListener listener) {
     ...
     *            对话框内容
     */
    public static AlertDialog dialog(Context context, Drawable icon,
     ...
     */
    public static AlertDialog dialog(Context context, Drawable icon,
                                     String title, String msg, OnClickListener okBtnListenner) {
    ...
    public static AlertDialog dialog(Context context, Drawable icon,
                                     String title, String msg, OnClickListener okBtnListenner,
                                     OnClickListener cancelBtnListenner) {
        ...
        if (null != okBtnListenner) {
            dialogBuilder
                    .setPositiveButton(android.R.string.ok, okBtnListenner);
        }
    ...
    public static void toastShort(String msg) {
        Toast.makeText(MyApplication.getMyApplication(), msg,
    ...
    public static void toastLong(String msg) {
        Toast.makeText(MyApplication.getMyApplication(), msg, Toast.LENGTH_LONG)
                .show();
    }
    ...
    public static void toast(String msg, int duration) {
        Toast.makeText(MyApplication.getMyApplication(), msg, duration).show();
    }
    ...
    public static void showShortToast(String str) {
        Toast toast = Toast.makeText(MyApplication.getMyApplication(), str, Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.CENTER, 0, 0);
		/*LinearLayout toastView = (LinearLayout) toast.getView();
		toastView.getBackground().setAlpha(100);*/
        // ImageView image = new ImageView(MyApplication.getMyApplication());
        // image.setImageResource(R.drawable.click_and_jump);
    ...
    public static void showLengthToast(String str) {
        Toast toast = Toast.makeText(MyApplication.getMyApplication(), str, Toast.LENGTH_LONG);
        toast.setGravity(Gravity.CENTER, 0, 0);
//		LinearLayout toastView = (LinearLayout) toast.getView();
//		toastView.getBackground().setAlpha(100);
        // ImageView image = new ImageView(MyApplication.getMyApplication());
        // image.setImageResource(R.drawable.ico_right);
        // toastView.addView(image, 0);
        toast.show();
    }
    ...
    public static void showCustomShortToast(String str) {
        ...
        TextView view=new TextView(MyApplication.getMyApplication());
        view.setGravity(Gravity.CENTER);
        view.setBackgroundColor(ContextCompat.getColor(MyApplication.getMyApplication(), R.color.black));
        view.getBackground().setAlpha(50);
        view.setPadding(ToolView.dip2px(MyApplication.getMyApplication(), 16), ToolView.dip2px(MyApplication.getMyApplication(), 8),
                ToolView.dip2px(MyApplication.getMyApplication(), 16), ToolView.dip2px(MyApplication.getMyApplication(), 8));
        view.setTextColor(ContextCompat.getColor(MyApplication.getMyApplication(), R.color.white));
        view.setTextSize(15);
        view.setText(str);
        toast.setGravity(Gravity.CENTER, 0, 0);
     ...
     * 中间弹出自定义toast 长
     */
    public static void showCustomLongToast(String str) {
        Toast toast = new Toast(MyApplication.getMyApplication());
        TextView view=new TextView(MyApplication.getMyApplication());
        view.setGravity(Gravity.CENTER);
        view.setBackgroundColor(ContextCompat.getColor(MyApplication.getMyApplication(), R.color.black));
     ...
     *            窗口Y偏移量
     */
    public static PopupWindow popwindow(Context context, View anchor,
                                        int viewId, int xoff, int yoff) {
        ViewGroup menuView = (ViewGroup) LayoutInflater.from(context).inflate(
                viewId, null);
        PopupWindow pw = new PopupWindow(menuView, LayoutParams.WRAP_CONTENT,
     ...
     *            窗口Y偏移量
     */
    public static PopupWindow popwindow(View anchor, View popView, int xoff,
                                        int yoff) {
        PopupWindow pw = new PopupWindow(popView, LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT, true);
        pw.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        pw.setOutsideTouchable(true);
        pw.showAsDropDown(anchor, xoff, yoff);
     ...
     */
    public static PopupWindow popwindow(Context context, View anchor,
                                        int viewId, int xoff, int yoff, boolean outSideTouchable) {
        ViewGroup menuView = (ViewGroup) LayoutInflater.from(context).inflate(
                viewId, null);
        PopupWindow pw = new PopupWindow(menuView, LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT, true);
     ...
     *            点击其他地方是否关闭窗口
     */
    public static PopupWindow popwindow(Context context, int viewId, boolean outSideTouchable) {
        ViewGroup menuView = (ViewGroup) LayoutInflater.from(context).inflate(
                viewId, null);
        PopupWindow pw = new PopupWindow(menuView, LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT, true);
     ...
     *            点击其他地方是否关闭窗口
     */
    public static PopupWindow popwindow(Context context, View menuView, boolean outSideTouchable) {
        PopupWindow pw = new PopupWindow(menuView);
     ...
     */
    public static PopupWindow popwindow(View anchor, View popView, int xoff,
                                        int yoff, boolean outSideTouchable) {
        PopupWindow pw = new PopupWindow(popView, LayoutParams.WRAP_CONTENT,
                LayoutParams.WRAP_CONTENT, true);
        pw.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        pw.setOutsideTouchable(outSideTouchable);
     ...
     *            窗口Y
     */
    public static PopupWindow popwindowLoction(PopupWindow pw, View anchor,
                                               View popView, int x, int y) {
        if (pw == null) {
        ...
        if (pw.isShowing()) {
            pw.update(x, y, LayoutParams.WRAP_CONTENT,
     ...
     *            消息Bean
     */
    public static void notificationCustom(Context mContext,NotificationMessage message) {
...
//				| Intent.FLAG_ACTIVITY_NEW_TASK);
        ...
        Notification notification = new Notification.Builder(mContext)
                .setSmallIcon(message.getIconResId())
                .setContentTitle(message.getMsgTitle())
                .setContentText(message.getMsgContent())
                .setWhen(System.currentTimeMillis())
                .setTicker(message.getStatusBarText())
                .setContentIntent(pIntent)
                .setDefaults(Notification.DEFAULT_SOUND)
                .setAutoCancel(true)
                .build();
        // 发送通知
        mNoticeManager.notify(message.getId(), notification);
    }
     ...
     *            消息Bean
     */
    public static void notificationCustomIntent(Context mContext,NotificationMessage message ,Intent mIntent) {
...
//				| Intent.FLAG_ACTIVITY_NEW_TASK);
    ...
    public static void notificationCustomView(Context mContext,
        ...
        Notification.Builder notification = new Notification.Builder(mContext)
                ...
                .setTicker(message.getStatusBarText())
                .setDefaults(Notification.DEFAULT_SOUND)
                .setContent(message.getmRemoteViews())
                .setAutoCancel(true);
        ...
        Notification noti=notification.setContentIntent(contentIntent).build();


        // 发送通知
        mNoticeManager.notify(message.getId(), noti);
    }
