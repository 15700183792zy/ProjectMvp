...
public class ToolView {
     ...
     * @return
     */
    public static int setDmSize(int size){
        return (int) (size* getDisplayMetrics(MyApplication.getMyApplication()).density);
    }
    ...
    public static int sp2px(Context context, float spValue) {
        DisplayMetrics mDisplayMetrics = getDisplayMetrics(context);
        return (int)applyDimension(TypedValue.COMPLEX_UNIT_SP,spValue,mDisplayMetrics);
    }
    ...
    public static void setViewSize(View view,int widthPixels, int heightPixels){
        ...
        if(params == null){
//            AbLogUtil.e(ToolView.class, "setViewSize出错,如果是代码new出来的View, 需要设置一个适合的LayoutParams");
            return;
        }
